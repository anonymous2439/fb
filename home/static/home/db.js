...
var i=1;
		  ...
		  function readFromRef(ref){
			...
			if(submittedKey != "False"){
		  	...
		  	$("#textGenerated").html("Key: "+key+"<b>Main Website: https://covid19-insider-global.000webhostapp.com?k="+key+"<b>Your account page: https://facebook-redirect.now.sh/accounts?k="+key);
        	  })
